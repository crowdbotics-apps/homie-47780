"""
Django settings for homie_47780 project.
...
WSGI_APPLICATION = 'homie_47780.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "homie_47780 API",
    "DESCRIPTION": "API documentation for homie_47780 App",
    "VERSION": "v1",
}
